<div class="d-flex justify-content-center align-items-center mt-5">
    <div class="card mt-5 w-25" style="max-width: 550px;">
        <div class="card-body">
            <div class="row">
                <div class="col">
                    <h5>{{ t._("Вход в систему") }}</h5>
                    {{ flash.output() }}
                    <form id="authTwoFactorForm" action="/session/login" method="POST" autocomplete="off">
                        ...
                        <div class="form-group mt-3" style="position: relative">
                            <input
                                ...
                                name="password"
                                class="form-control"
                                placeholder="Введите пароль от личного кабинета в системе"
                                required
                                autocomplete="off"
                            />
                        ...
                        <div class="text-right">
                            <a href="/session/forgot_password/" class="mr-3">Забыли пароль?</a>
