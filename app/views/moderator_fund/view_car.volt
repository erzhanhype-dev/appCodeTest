...
<!-- /авто -->
<div class="row" id="MODERATOR_FUND_VIEW_FORM">
    <div class="col">
        <div class="card mt-3">
            <div class="card-header bg-dark text-light">
                <div class="row">
                    ...
                    <?php ?>
                    {% if fund.approve == 'FUND_DONE' and auth is defined and auth.isSuperModerator() %}
                        <div class="row ml-1">
            ...
            <div class="card-body">
                <table id="moderatorFundCarList" class="display" cellspacing="0" width="100%">
                    <thead>
                    <tr>
                        <th>{{ t._("ID") }}</th>
                    ...
                    {% if fund_cars is not empty %}
                        {% for item in fund_cars %}
                            <tr>
                                ...
                                <td>{{ item['ref_car_cat'] }}</td>
                                <td>
                                    {% if auth is defined and auth.isSuperModerator() %}
                                        <a href="/fund_correction/view_car/{{ item['id'] }}" id="fund_correction_btn"
...
<!-- /авто(Аннулированные) -->
{% if deleted_car is not empty %}
    <div class="row">
        <div class="col">
            <div class="card mt-3">
                <div class="card-header bg-danger text-light">
                    {{ t._("Аннулированные и Отклоненные ТС") }}
                </div>
                <div class="card-body">
                    <table id="moderatorFundCarCancelledList" class="display" cellspacing="0" width="100%">
                        <thead>
                        <tr class="">
                            <th>{{ t._("ID") }}</th>
                            <th>{{ t._("Объем, вес или мощность") }}</th>
        ...
        <div class="col">
            <div class="card mt-3">
                ...
                <div class="card-body">
                            ...
                            <p><a href="/fund/viewtmp/<?php echo $fund->id; ?>/payment/"
                                ...
                                <a class="btn btn-xs btn-success"
                                   href="/fund/viewtmp/<?php echo $fund->id; ?>/payment">
                                    <i data-feather="download" width="14" height="14"></i>&nbsp;Cкачать</a>&nbsp;
                            </p>
                        </div>
                    </div>
                    <hr>
                    <div class="row">
                        <div class="col">
                            {% if auth is defined and (auth.isModerator() or auth.isSuperModerator()) %}
