...
{{ form("fund_car/edit/"~car.id, "method": "post", "id": "frm_car") }}
        ...
        <div class="card-body">
          ...
          <div class="form-group">
            ...
            <div class="controls">
              ...
              value="<?php $_ic = explode('-', $car->vin); echo $_ic[0]; ?>" autocomplete="off" 
                    required {{ editable }}>
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="controls">
              ...
              value="<?php $_ic = explode('-', $car->vin); echo $_ic[1]; ?>" autocomplete="off" 
                    required {{ editable }}>
            </div>
          </div>
          {% endif %}
