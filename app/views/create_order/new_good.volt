...
<form action="/create_order/add_good" method="post" id="frm_goods">
      ...
      <div class="card mt-3">
        ...
        <div class="card-body">
          ...
          <div class="form-group">
            ...
            <div class="controls">
              <input type="text" name="good_basis" id="good_basis" class="form-control" maxlength="50" required>
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="controls">
            <div class="btn-group btn-group-toggle" data-toggle="buttons">
              <label class="btn btn-wide btn-secondary">
                <input type="radio" name="calculate_method" value="dt_import">
                По дате производства(импорта)
              </label>
              <label class="btn btn-wide btn-secondary">
                <input type="radio" name="calculate_method" value="dt_sent" >
          ...
          <div class="form-group" id="car_cat_group">
            ...
            <select name="good_country" id="good_country" class="selectpicker form-control" data-live-search="true">
              {% for i, cc in country %}
                <option value="{{ cc.id }}"{% if cc.alpha2 == 'UNKNOWN' %}selected{% endif %}>{{ t._(cc.name) }}</option>
              {% endfor %}
            </select>
          </div>
          <div class="form-group" id="car_cat_group">
          ...
          <div class="collapse" id="tn-code-add">
            <div class="form-group">
              ...
              <select name="tn_code_add" id="tn_code_add" class="selectpicker form-control" data-live-search="true">
                ...
                {% for i, code in package_tn_codes %}
