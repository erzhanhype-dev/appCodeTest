...
<form enctype="multipart/form-data" action="/create_order/upload_car" method="POST">
...
<div class="row">
  ...
  <div class="col">
    <div class="card mt-3">
      ...
      <div class="card-body">
        <p>Для подготовки корректного CSV-файла для импорта, воспользуйтесь <a href="/examples/ImportExampleCarModeratorNew.xlsx?ver=2.0">примером <span class="badge badge-pill badge-danger">Новый</span></a>. Данном файле приложен справочник типов, стран и категорий транспортных средств.</p>
