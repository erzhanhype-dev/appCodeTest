...
<form enctype="multipart/form-data" action="/create_order/upload_good" method="POST" autocomplete="off">
...
<div class="row">
  ...
  <div class="col">
    <div class="card mt-3">
      ...
      <div class="card-body">
        <p>Для подготовки корректного CSV-файла для импорта, воспользуйтесь <a href="/examples/ImportExampleGoodsModeratorNew.xlsx">примером <span class="badge badge-pill badge-danger">Новый</span></a>. В данном файле приложен справочник типов, стран и коды ТНВЭД.</p>
