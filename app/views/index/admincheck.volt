  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-1 col-md-offset-0 col-sm-2 col-sm-offset-0 col-xs-3 col-xs-offset-3 text-center lang">
        {% if !session.get('pl') or session.get('pl') == 'ru' %}<a href="/index/cl_admin/kk"><img src="/assets/img/rukz.png" alt="" /></a>{% endif %}
        {% if session.get('pl') == 'kk' %}<a href="/index/cl_admin/ru"><img src="/assets/img/kzru.png" alt="" /></a>{% endif %}
      </div>
...
<div class="container-fluid" id="check-form">
  <div class="container">
    <div class="row">
      <form id="frm_check" method="POST" action="/index/admincheck/" autocomplete="off">
        ...
        <div class="col-sm-7 col-sm-offset-3">
          <div class="whiteboard">
            ...
            <table>
              ...
              <tr>
                <td class="text-left">{{ t._("STATUS") }}</td>
                <td class="text-right">{{ tr.approve }}</td>
              </tr>
              <tr>
                <td class="text-left">{{ t._("SIGN") }}</td>
                <td class="text-right">{{ tr.ac_approve }}</td>
              </tr>
            </table>
          </div>
        </div>
