...
<form method="get" action="/zd_operator_bank/bank" class="card mt-3">
  ...
  <div class="card-body">
    <div class="row">
      ...
      <div class="col-2">
        ...
        <input name="reference" type="text" class="form-control" value="{{ filters.reference }}">
      </div>
      <div class="col-2">
      ...
      <div class="col-2">
        ...
        <select name="iban_to[]" class="form-control selectpicker" multiple size="6">
          {% for iban in ibans %}
            <option value="{{ iban }}"
      ...
      <div class="col-auto mt-4">
        ...
        <a href="/zd_operator_bank/bank?clear_filters=1" class="btn btn-warning">{{ t._('Сбросить фильтр') }}</a>
      </div>
    </div>
  </div>
</form>
