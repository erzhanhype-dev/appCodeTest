...
<form method="get" action="/operator_bank/bank" class="card mt-3" autocomplete="off">
  ...
  <div class="card-body">
    <div class="row">
      ...
      <div class="col-auto mt-4">
        ...
        <a href="/operator_bank/bank?clear_filters=1" class="btn btn-warning">{{ t._('Сбросить фильтр') }}</a>
      </div>
    </div>
  </div>
</form>
