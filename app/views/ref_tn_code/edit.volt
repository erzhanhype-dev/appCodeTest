<!-- заголовок -->
<h2>{{ t._("Редактировать код ТН ВЭД") }}</h2>
<!-- /заголовок -->
...
<div class="card mt-3">
    ...
    <div class="card-body">
        <form action="/ref_tn_code/save" method="POST" autocomplete="off" class="form-horizontal form-100">
                ...
                <div class="row mt-2">
                    <div class="col">
                        <div class="btn-group" data-toggle="buttons">
                            ...
                            <label class="btn btn-wide btn-danger">
                                {{ radio_field("is_correct", "size" : 30, "value" : 0) }} Неактивный
                            </label>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col">
                        <div class="btn-group" data-toggle="buttons">
                            <label class="btn btn-wide btn-info active">
                                {{ radio_field("type", "size" : 30, "value" : "PRODUCT") }} Товар
                            </label>
